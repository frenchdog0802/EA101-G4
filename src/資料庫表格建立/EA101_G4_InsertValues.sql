...
Insert into ACT_FAVORITE (SQ_ACTIVITY_ID,SQ_MEMBER_ID,FAVORITE_TIME) values ('ACT-700007','910001',to_date('2020-03-25 20:00:42', 'yyyy-mm-dd hh24:mi:ss'));
Insert into ACT_FAVORITE (SQ_ACTIVITY_ID,SQ_MEMBER_ID,FAVORITE_TIME) values ('ACT-700008','910001',to_date('2020-03-29 16:31:57', 'yyyy-mm-dd hh24:mi:ss'));
Insert into ACT_FAVORITE (SQ_ACTIVITY_ID,SQ_MEMBER_ID,FAVORITE_TIME) values ('ACT-700009','910001',to_date('2020-04-11 23:04:38', 'yyyy-mm-dd hh24:mi:ss'));
Insert into ACT_FAVORITE (SQ_ACTIVITY_ID,SQ_MEMBER_ID,FAVORITE_TIME) values ('ACT-700010','910001',to_date('2020-05-20 10:15:17', 'yyyy-mm-dd hh24:mi:ss'));
...
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'公路單車','單車界的F1','它的特徵是擁有極細的輪胎和彎曲到下方的彎把。在單車體育賽事中，追求高速騎行性能而設計的一種。當然可以參加單車賽事，也可以騎著去上班。與風融為一體的快速騎行感覺，是公路單車的最大魅力也是其長處。',450, load_blob('bike_img_road.jpg'));
INSERT INTO  bike_type
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'公路越野車','具備多項功能的單車','是一款結合了公路單車和登山車兩種車型之長處的萬能單車。騎行非常流暢以及穩定。即使是崎嶇路面也能順暢行駛。此單車類型不僅適合休閒逛街騎乘，也非常適合初學者騎乘。可以依據用戶需求設定，來發揮它的全能性能。',300,load_blob('bike_img_cross.jpg'));
INSERT INTO  bike_type
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'登山車','不受任何地形限制的高性能單車','正如其名，是為了能順暢的行駛在山岳地帶或崎嶇路面而設計的一款單車，並充分發揮其疾馳的性能。輪胎寬厚，所以造成的路面阻力也大，在平整的路面上可能速度不是很快，但是不必受道路的崎嶇不平限制，可以說也是一款非常值得信賴的公路騎行單車。',300,load_blob('bike_img_mountain.jpg'));
INSERT INTO  bike_type
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'小徑車','依據生活習慣來享受小徑車的樂趣','小徑單車有大約20英寸的輪胎。騎行非常輕便，適合要頻繁停車的日常騎車逛街的用戶。設計是自由型，可以折疊的款式，便於收納。依據個人生活習慣來調整的車型。不適合段差大和崎嶇不平的道路。',400,load_blob('bike_img_mini.jpg'));
INSERT INTO  bike_type
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'城市單車','最常見的單車 ， 俗稱：媽媽車。','這是最常見的單車類型。一般用於購物、通勤或上學。在日常生活中，是一款實用性非常高的單車，特別適合女性和年長者。而且，單車種類非常豐富，從價格便宜的款式到時尚款式，適應不同需求。',200,load_blob('bike_img_city.jpg'));
INSERT INTO  bike_type
(sq_bike_type_id,bike_type_name,bike_title,bike_description,bike_price,bike_photo)
VALUES
(sq_bike_type_id.NEXTVAL,'電動單車','爬坡也可以很順暢','正如其名，借用電力作為前進動力的單車。騎單車載小孩或騎單車爬坡時，借用電力使你的行駛更加輕鬆。萬一電池沒電時，也可以和一般的單車一樣踩踏前行。',500,load_blob('bike_img_auto.jpg'));
...
--------------------------------------------------------
INSERT INTO bike_rent_detail(sq_rent_detail_id,sq_rent_id,sq_bike_type_id,sq_bike_id ,price,rsved_rent_date,ex_return_date,real_return_date,extra_cost )VALUES(sq_rent_detail_id.NEXTVAL,'RT-600001','630001',null,450,to_date('2020-08-28', 'yyyy-mm-dd'),to_date('2020-09-28', 'yyyy-mm-dd'),null,null);
INSERT INTO bike_rent_detail(sq_rent_detail_id,sq_rent_id,sq_bike_type_id,sq_bike_id ,price,rsved_rent_date,ex_return_date,real_return_date,extra_cost )VALUES(sq_rent_detail_id.NEXTVAL,'RT-600002','630003',null,300,to_date('2020-07-28', 'yyyy-mm-dd'),to_date('2020-08-01', 'yyyy-mm-dd'),null,null);
INSERT INTO bike_rent_detail(sq_rent_detail_id,sq_rent_id,sq_bike_type_id,sq_bike_id ,price,rsved_rent_date,ex_return_date,real_return_date,extra_cost )VALUES(sq_rent_detail_id.NEXTVAL,'RT-600003','630005',null,200,to_date('2020-07-05', 'yyyy-mm-dd'),to_date('2020-07-10', 'yyyy-mm-dd'),null,null);
INSERT INTO bike_rent_detail(sq_rent_detail_id,sq_rent_id,sq_bike_type_id,sq_bike_id ,price,rsved_rent_date,ex_return_date,real_return_date,extra_cost )VALUES(sq_rent_detail_id.NEXTVAL,'RT-600004','630003',null,300,to_date('2020-07-15', 'yyyy-mm-dd'),to_date('2020-08-01', 'yyyy-mm-dd'),null,null);
INSERT INTO bike_rent_detail(sq_rent_detail_id,sq_rent_id,sq_bike_type_id,sq_bike_id ,price,rsved_rent_date,ex_return_date,real_return_date,extra_cost )VALUES(sq_rent_detail_id.NEXTVAL,'RT-600005','630005',null,200,to_date('2020-06-28', 'yyyy-mm-dd'),to_date('2020-07-01', 'yyyy-mm-dd'),null,null);
