...
INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  ...
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'ASDF151524','ASDF123456','江武揚','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168111','doodoo@abaom.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem4.jpg'),NULL,'江武揚','桃園市中壢區中大路300號');

  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'ASDF6666','ASDF123456','孤獨山姆','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','sam@tomcat.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem5.jpg'),NULL,'孤獨山姆','桃園市中壢區中大路300號');  
  
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'ASDF11666','ASDF123456','寒導演','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','hau11@tomcat.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem6.jpg'),NULL,'譁導','桃園市中壢區中大路300號');  
  
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'cc6666','ASDF123456','蕭大寶','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','hau11@tomcat.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem7.jpg'),NULL,'蕭大寶','桃園市中壢區中大路300號'); 
  
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'cc7777','ASDF123456','周星星','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','hau11@tomcat.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem8.jpg'),NULL,'9527蕭大寶','桃園市中壢區中大路300號'); 
  
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'cc7777','ASDF123456','唐龍','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','hau11@tomcat.com','0',
  TO_DATE('2020-06-06','YYYY-MM-DD'),load_blob('mem9.jpg'),NULL,'唐龍','桃園市中壢區中大路300號'); 
  
  INSERT INTO MEMBER (SQ_MEMBER_ID,MEMBER_ACCOUNT,PASSWORD,M_NAME,GENDER,BIRTHDAY,CELLPHONE,M_EMAIL,VALIDATION,
  REGISTERED,M_PHOTO,BACK_IMG,NICK_NAME,ADDRESS) 
  VALUES(member_seq.NEXTVAL,'ASDF7777','ASDF123456','趙二虎','1',TO_DATE('2020-06-06','YYYY-MM-DD'),'0908168188','hau11@tomcat.com','0',
