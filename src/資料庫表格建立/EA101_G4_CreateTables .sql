...
CREATE TABLE ACTIVITYREPORT (
  SQ_ACTICITYREPORT_ID VARCHAR2(40) PRIMARY KEY NOT NULL, 
  SQ_ACTIVITY_ID VARCHAR2(40) NOT NULL, 
  SQ_MEMBER_ID VARCHAR2(40) NOT NULL, 
  REPORT_REASON VARCHAR2(200), 
  REPORT_STATUS NUMBER(1) NOT NULL,
  CONSTRAINT FK_ACTIVITYYREPORT_1 FOREIGN KEY (SQ_ACTIVITY_ID) REFERENCES ACTIVITY (SQ_ACTIVITY_ID),
...
CREATE TABLE SHOP_ORDER_DETAIL(
      ...
      CONSTRAINT ORDER_ID_FK FOREIGN KEY (SQ_ORDER_ID) REFERENCES SHOP_ORDER (SQ_ORDER_ID),
