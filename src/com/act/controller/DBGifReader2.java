...
public class DBGifReader2 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String ID = req.getParameter("SQ_ACTIVITY_ID");
			ResultSet rs = stmt.executeQuery(
				"SELECT ACT_PICTURE FROM ACTIVITY WHERE SQ_ACTIVITY_ID=" +ID );

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("ACT_PICTURE"));
