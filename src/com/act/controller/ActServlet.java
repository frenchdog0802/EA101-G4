	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("update".equals(action)) { // 來自update_act_input.jsp的請求
			...
			try {
				...
				Integer gp_status = new Integer(req.getParameter("gp_status").trim());
				try {
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req
							.getRequestDispatcher("/back-end/activity/update_act_input.jsp");
					failureView.forward(req, res);
					return; //程式中斷
				}
				...
				actVO = actSvc.updateAct(
						...
						act_picture, gp_status, sq_activity_id);
