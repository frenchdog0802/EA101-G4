...
//		BikeRentMasterVO.setRsved_rent_date(java.sql.Date.valueOf("2020-06-06"));
//		BikeRentMasterVO.setReal_rent_date(java.sql.Date.valueOf("2020-06-06"));
//		BikeRentMasterVO.setEx_return_date(java.sql.Date.valueOf("2020-06-09"));
//		BikeRentMasterVO.setReal_return_date(java.sql.Date.valueOf("2020-06-09"));
//		BikeRentMasterVO.setOd_total_price(13333);
//		BikeRentMasterVO.setOd_price(13333);
//		BikeRentMasterVO.setRent_name("蕭琮保");
//		BikeRentMasterVO.setRent_phone("0987456321");
//		BikeRentMasterVO.setRent_od_status(1);
//		BikeRentMasterVO.setPick_up_status(0);
//		
...
//		BikeRentMasterVO BikeRentMasterVO = new BikeRentMasterVO();
//		
//		BikeRentMasterVO.setSq_rent_id("600006");
//		BikeRentMasterVO.setSq_member_id("910002");
//		BikeRentMasterVO.setSq_bike_store_id("620001");
//		BikeRentMasterVO.setRent_payment(1);
//		BikeRentMasterVO.setRsved_rent_date(java.sql.Date.valueOf("2020-06-06"));
