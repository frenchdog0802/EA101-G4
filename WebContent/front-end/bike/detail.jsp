...
<body>
	...
	<div class="container my-5">
		<div class="row ">
			<div class="col">
				...
				<img
					...
					class="img-thumbnail" id="bike-img" alt="" width="300" height="300" />
			</div>
			<div class="col">
				<!-- 預定車型 -->
				您預定的車型是:
				<c:forEach var="item" items="${bookMap}">
					<div>
						${BikeTypeSvc.findByPrimaryKey(item.key).bike_type_name} x ${item.value} 輛
					</div>
				</c:forEach>
			</div>
		...
		<div class="container  font-weight-bold p-4 mt-3 conGray">
			...
			<div class="row">
				...
				<div class="col offset-3 text-danger h4">${days==0?0:days}天 ${hours==0?0:hours}小時 </div>
			</div>
			<div class="row">
		...
		<div class="container mt-3">
			<div class="row text-center">
				<div class="col">
					<input type="submit" class="btn btn-danger btn-lg" value="修改資訊(還未做功能)">
				</div>
				<div class="col">
	...
	<script>
		$(function() {
			...
			$(".startTime").text(getDayOfWeek(startDate)+" "+startDateStr[1]);
