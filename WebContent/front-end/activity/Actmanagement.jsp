			...
			<div class="row">
				...
				<div class="col-lg-3 mb-4">
					<div class="list-group">
						<a href="index.html" class="list-group-item active">參加的活動</a> 
						<a href="about.html" class="list-group-item">主辦的活動</a> 
						<a href="services.html" class="list-group-item">收藏的活動</a> 
