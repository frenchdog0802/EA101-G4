	...
	<%@include file="/front-end/page-file/page-nav"%>
 	...
 	<div class="container my-5">
 		<div class="container-fluid">
 			<div class="col-12">
	 			<h1 class="mt-4 mb-3">
				商城訂單<a class="btn btn-primary float-right mt-1"
					href="<%=request.getContextPath()%>/front-end/member/shopMallOderHistory.jsp">歷史訂單</a>
				</h1>
				<ol class="breadcrumb">
							...
							<table class="table">
							    <tbody>			    	
							        ...
							        <tr style="background-color: #ecf0f1;">
							        	...
							        	<td>信用卡</td>
							        	<td>
							        		<%if(orderList.get(i).getOrder_status() == 0){%>
							        			處理中
							        		<%}else if(orderList.get(i).getOrder_status() == 1){%>
							        			已出貨
							        		<%}else if(orderList.get(i).getOrder_status() == 2){%>
							        			已到門市
							        		<%}%>
							        	</td>
							        </tr>
