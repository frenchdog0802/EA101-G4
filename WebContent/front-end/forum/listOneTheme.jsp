		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<p>
						Posted on
						<%=(forumVO == null) ? " " : forumVO.getTheme_time()%></p>
					...
					<!-- Comments Form -->
					<div class="card my-4">
						<h5 class="card-header">Leave a Comment:&nbsp
							${memLoginVO.nick_name}</h5>
						...
						<div class="shadow-sm mb-5 bg-white rounded row" id="message">
							<div class="col-11">
								...
								<c:forEach var="listmember" items="${memberSvc.all}">
									<c:if
										test="${listmember.sq_member_id == forumMessageVO.sq_member_id}">

										<img
											src="<%=request.getContextPath()%>/member/DBReader.do?sq_member_id=${listmember.sq_member_id}"
