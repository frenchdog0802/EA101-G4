...
<head>
	...
	<link rel="stylesheet" href="/EA101_G4/${contextPath}/bootstrap-components/css/bootstrap.min.css">
...
<body>
			...
			<div class="col">
				<form>
					<div class="form-group row">
						...
						<input type="text" class="col-sm-10 form-control" id="bikeType"  placeholder="請輸入車種類型">
					...
					<div class="form-group row">
						...
						<input type="text" class="col-sm-10 form-control" id="bikeTitle" placeholder="請輸入單車標題">
					</div>
					
					<div class="form-group row" >
						<label for="bikePrice" class="col-sm-2 col-form-label">價格</label>
						<input type="number" class="col-sm-10 form-control" id="bikePrice" placeholder="價格">
					</div>
	...
	<script src="/EA101_G4/${contextPath}/bootstrap-components/js/bootstrap.min.js"></script>
	<script>
