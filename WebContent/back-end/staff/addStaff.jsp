...
<div class="row" style="background-color: white;">
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/back-end/staff/listAllStaff.jsp"><span>全部員工</span></a>
			<!--在哪一個頁面就哪加active和span的style--></li>
		<li class="nav-item"><a class="nav-link active" href="<%=request.getContextPath()%>/back-end/staff/addStaff.jsp"><span style="padding-bottom: 8px; border-bottom: 3px blue solid;">新增員工</span></a>
		</li>
	</ul>
</div>
<!--分頁自己改-->
	...
	<div class="row">
		<div class="col">
			<form method="POST"
				...
				<!--email -->
				<div class="form-group row">
					<label for="sf_email" class="col-sm-2 col-form-label ">信箱:</label> <input
						type="email"
						class="col-sm-10 form-control ${errorMsgs.sf_email==null?'':'is-invalid'}"
						id="sf_email" name="sf_email" placeholder="請輸入信箱" autocomplete="off"
						autoCorrect="off" value="${param.sf_email}">
					<!--errorMsg -->
				...
				<!--sf_address -->
				<div class="form-group row">
					<label for="sf_address" class="col-sm-2 col-form-label ">地址:</label> <input
						type="text" name="sf_address" value="${param.sf_address}"
