...
<FORM METHOD="post"
	...
	<b>輸入活動檢舉編號 (如710000):</b> <input type="text"
		name="sq_activityreport_id"> <input type="hidden"
...
<div class="container-fluid mt-3">
	<div class="table-responsive">
		<table
			...
			<tbody>
				<tr>
					<td style="vertical-align: middle"><%=actreportVO.getSq_activityreport_id()%></td>
					<td style="vertical-align: middle"><%=actreportVO.getSq_activity_id()%></td>
					<td style="vertical-align: middle"><%=actreportVO.getSq_member_id()%></td>
					<td class="des" style="vertical-align: middle"><button
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-body" style="text-align: left;">
										<span><%=actreportVO.getReport_reason()%></span>
									</div>
						...
						<div class="modal fade" id="exampleModalCenter1${vs.index}"
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-body" style="text-align: left;">
										<span><%=actreportVO.getReport_response()%></span>
									</div>
									<div class="modal-footer" style="text-align: center;">
										<button type="button" class="btn btn-secondary"
											data-dismiss="modal">Close</button>
					...
					<td style="vertical-align: middle"><%=actreportVO.getReport_status()%></td>
