    					...
    					<div id="brandcontent">
    						<table>
				    			...
				    			<tr>
				    				...
				    				<td><%=brandVO.getBrand_name()%></td>
				    				<td><%=brandVO.getBrand_phone()%></td>
				    				<td><%=brandVO.getBrand_address()%></td>
				    				<td>
                             	    	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter${brandVO.getSq_brand_id()}">圖片</button>
                                        	<div class="modal fade" id="exampleModalCenter${brandVO.getSq_brand_id()}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            	<div class="modal-dialog modal-dialog-centered" role="document">
                                                	...
                                                	<div class="modal-body">
                                                    	<img src="/EA101G4/showImg?id=${brandVO.getSq_brand_id()}" class="img-fluid">
                                                	</div>
