...
<div class="row" style="background-color: white;">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item"><a class="nav-link active" href="<%=request.getContextPath()%>/bike/BikeStoreServlet.do?action=bikeStoreOwner&sq_bike_store_id=${BikeStoreVO.sq_bike_store_id}" ><span style="padding-bottom: 8px; border-bottom: 3px blue solid;">店家資訊</span></a>
		</li>
	</ul>
</div>
<!--分頁自己改-->
	...
	<div class="row mt-3">
		<div class="col">
			<form method="POST"
				...
				<input type="hidden" name="action" value="getOne_For_Update_bikeStoreOwner">
