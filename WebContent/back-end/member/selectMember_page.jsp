...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back-end/member/listAllMember.jsp'>List</a> all Member. <br> <br></li>
	...
	<ul>
		<li>
		<a href='<%=request.getContextPath()%>/back-end/member/addMember.jsp'>Add</a>
			a new Member.</li>
