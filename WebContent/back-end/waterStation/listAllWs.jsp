...
<div class="row" style="background-color: white;">
	<ul class="nav nav-tabs">
		<li class="nav-item">
			<a class="nav-link" href="<%=request.getContextPath()%>/back-end/route/listAllRouDe.jsp">
				<span>所有路線資料</span>
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link active" href="<%=request.getContextPath()%>/back-end/waterStation/listAllWs.jsp">
				<span style="padding-bottom: 8px; border-bottom: 3px blue solid;">所有補水站資料</span>
			</a>
		</li>
	</ul>
</div>
				...
				<tr>
					...
					<FORM METHOD="post"	ACTION="<%=request.getContextPath()%>/back-end/waterStation/water.do" name="form1">
						...
						<td>
							...
							<input type="hidden" name="sqStationId" value="${wsVO.sqStationId}"> 
